...
# Die Werte dieses Portals - Domain, Titel, Newsletter-Praefix -
# kommen seit dem 04.09.2026 zur Laufzeit aus portal.json, nicht mehr
# als Platzhalter beim Erzeugen des Portals. Erst dadurch laesst sich
# diese Datei gemeinsam nutzen.
from portalwerte import (DATEI_PRAEFIX, DOMAIN, MC_GRUPPE_NAME, MC_PRAEFIX, MC_TAG_ID,
                         REPO, THEMA_ASCII, TITEL)

TZ = ZoneInfo("Europe/Berlin")

LIST_ID = "1c8fc10ec7"          # Zielgruppe "eRelation GESAMT"
# Tag "Studien-Newsletter <Titel>" (Tags sind statische Segmente). Die Nummer steht
...
SEITE = f"https://{DOMAIN}"   # DOMAIN kommt seit dem 04.09.2026 aus
                             # portal.json, nicht mehr aus einer Ersetzung
                             # beim Erzeugen des Portals.
...
# mit startswith(), also wuerde "MVF Studien-Newsletter <Titel> ..." drueben als
...
# Bewusst verkettet und kein f-String: Der Block besteht aus CSS-Regeln,
# und in einem f-String muesste jede ihrer geschweiften Klammern
# verdoppelt werden. Ein vergessenes Paar faellt erst im ausgelieferten
# Newsletter auf.
SCHRIFT_EINBINDEN = (
    '<style type="text/css">\n'
    "@font-face{font-family:'Lato';font-style:normal;font-weight:400;\n"
    "  src:url('https://" + DOMAIN + "/fonts/lato-400.woff2') format('woff2');}\n"
    "@font-face{font-family:'Lato';font-style:normal;font-weight:700;\n"
    "  src:url('https://" + DOMAIN + "/fonts/lato-700.woff2') format('woff2');}\n"
    "</style>"
)
...
<tr><td align="center" style="padding:24px 12px;">
  <table role="presentation" width="600" cellpadding="0" cellspacing="0" border="0" style="width:600px;max-width:600px;background:#ffffff;">
    ...
    <tr><td style="background:#ffffff;padding:18px 28px 14px;">
      <a href="https://{DOMAIN}/?{p}&amp;utm_content=logo" style="text-decoration:none;">
        <img src="https://{DOMAIN}/logo/mvf-logo.png" width="170" height="45"
    ...
    <tr><td style="padding:24px 28px 4px;">
      <p style="margin:0;font:15px/1.65 {FONT};color:#333;">
        ...
        <a href="https://{DOMAIN}/?{p}&amp;utm_content=intro" style="color:{BLAU};font-weight:bold;">Knowledge-Hub</a>.</p>
    </td></tr>
{studienteil(studien)}
{rubriken}
    ...
    <tr><td style="padding:26px 28px 0;" align="center">
      <table role="presentation" cellpadding="0" cellspacing="0" border="0">
        <tr><td style="background:{GOLD};">
          <a href="https://{DOMAIN}/?{p}&amp;utm_content=cta"
      ...
      <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr><td style="border-top:1px solid #D0D8E4;padding-top:18px;font:12px/1.7 {FONT};color:#777;">
          ...
          <p style="margin:0;">
            ...
            <a href="https://{DOMAIN}/#datenschutz" style="color:#777;">Datenschutz</a></p>
        </td></tr>
      </table>
    </td></tr>
  </table>
...
def main() -> int:
    ...
    t = tage(offen)
    betreff = (f"Neueste Studien - {THEMA_ASCII} – " +
